...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_analytics"></a> [analytics](#module\_analytics) | /home/user02/GIT/04/src/modules/analytics/ | n/a |
| <a name="module_marketing"></a> [marketing](#module\_marketing) | git::https://github.com/udjin10/yandex_compute_instance.git | main |
| <a name="module_vpc_module"></a> [vpc\_module](#module\_vpc\_module) | /home/user02/GIT/04/src/modules/vpc_module | n/a |
...
| <a name="output_vpc_out"></a> [vpc\_out](#output\_vpc\_out) | n/a |
<!-- END_TF_DOCS -->